namespace Chess.Models.Figures
{
    ...
    public class King : IFigure
    {
            ...
            if (this.IsFirstMove && toRow == square.Row)
            {
                if (toCol == square.Col + 2)
                {
                    if (this.OccupiedSquaresCheck(toRow, toCol, matrix, square) && matrix[(int)square.Row][7].Figure is Rook && matrix[(int)square.Row][7].Figure.IsFirstMove)
                    {
                        ...
                        ISquare emptySquare = Factory.GetSquare(square.Row, (Col)7, square.Color, emptyFigure);
                ...
                if (toCol == square.Col - 2)
                {
                    if (this.OccupiedSquaresCheck(toRow, toCol, matrix, square) && matrix[(int)square.Row][0].Figure is Rook && matrix[(int)square.Row][0].Figure.IsFirstMove)
                    {
                        ...
                        IFigure emptyFigure = Factory.GetEmpty();
                        ISquare emptySquare = Factory.GetSquare(square.Row, (Col)0, square.Color, emptyFigure);
        ...
        {
            if (toCol == square.Col && toRow == square.Row - 1 && !(matrix[(int)toRow][(int)toCol].Figure is King))
            {
                square.Row -= 1;
                this.IsFirstMove = false;
                return true;
            ...
            if (toCol == square.Col + 1 && toRow == square.Row - 1 && !(matrix[(int)toRow][(int)toCol].Figure is King))
            {
                square.Row -= 1;
                square.Col += 1;
                this.IsFirstMove = false;
            ...
            if (toCol == square.Col + 1 && toRow == square.Row && !(matrix[(int)toRow][(int)toCol].Figure is King))
            {
                square.Col += 1;
                this.IsFirstMove = false;
                return true;
